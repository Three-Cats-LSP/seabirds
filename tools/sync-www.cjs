...
for(const file of ['index.html','app.css','seabirds.css','app.js','shearwater.js','sync.js','plot-core.js','manifest.webmanifest','icon.svg','firebase-config.js','sw.js'])fs.copyFileSync(path.join(root,file),path.join(www,file));
