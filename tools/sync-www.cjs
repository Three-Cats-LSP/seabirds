...
for(const file of ['index.html','app.css','seabirds.css','app.js','shearwater.js','sync.js','plot-core.js','manifest.webmanifest','icon.svg','icon-192.png','icon-512.png','seabirds-app-icon.png','firebase-config.js','sw.js','tab-profile.png','tab-notes.png','tab-equipment.png','tab-information.png'])fs.copyFileSync(path.join(root,file),path.join(www,file));
